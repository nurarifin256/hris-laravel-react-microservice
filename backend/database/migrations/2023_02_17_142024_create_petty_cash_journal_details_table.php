...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('petty_cash_journal_details', function (Blueprint $table) {
            $table->id();
            $table->string('number_journal', 25)->references('number')->on('petty_cash_journals');
    ...
    {
        Schema::dropIfExists('petty_cash_journal_details');
    }
};
